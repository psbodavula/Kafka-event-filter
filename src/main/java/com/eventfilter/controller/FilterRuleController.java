...
public class FilterRuleController {
    ...
    private FilterRule mapToEntity(FilterRuleRequest request) {
        return FilterRule.builder()
                ...
                .spelExpression(request.getSpelExpression())
                .fieldConditions(request.getFieldConditions())
                .childRuleIds(request.getChildRuleIds())
                .compositeOperator(request.getCompositeOperator())
